...
const MPriceButtonGreen = styled(Button, {
  name: "MPriceButtonGreen",
  slot: "root",
})(({}) => ({}));
...
export default function PriceButtonGreen(props: ButtonProps) {
  const formattedPrice = props.oldPrice
    .toLocaleString("en-US")
    .replace(/,/g, " ");
  return (
    <Link href={props.url} style={{ textDecoration: "none" }}>
      <MPriceButtonGreen>
        <div className="s_green_btn_new_price">
          {formattedPrice}
          <svg
            width="18"
            height="22"
        ...
        <div className="s_green_btn_old_price">{formattedPrice}₴</div>
      </MPriceButtonGreen>
    </Link>
  );
}
